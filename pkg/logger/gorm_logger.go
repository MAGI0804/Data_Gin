// 自定义 gorm 的 logger
// document link: https://gorm.io/docs/logger.html
package logger
...
func NewGormLogger() GormLogger {
	return GormLogger{
		ZapLogger:     Logger,                 // 使用全局的 logger.Logger 对象（即 *zap.Logger）
		SlowThreshold: 200 * time.Millisecond, // 慢查询阀值，单位为：毫秒（千分之一秒）
	}
}
...
// logger 内用的辅助方法，确保 Zap 内置信息 Caller 的准确性（如 model/user_model.go:135）
